#
//  fix-custom-forms-write.sh
//  
//
//  Created by Calvin Fowler on 10/31/25.
//
...
echo "==> Rewriting Custom Forms files with safe here-docs"
...
# --- SQL migration ---
cat > "$ROOT/sql/2025-10-31_custom_forms.sql" <<'SQL'
...
# --- API controller ---
cat > "$ROOT/services/api/src/modules/forms/customForms.controller.ts" <<'TS'
// Mounted at /v0
...
# --- API service ---
cat > "$ROOT/services/api/src/modules/forms/customForms.service.ts" <<'TS'
...
# --- Web client ---
cat > "$ROOT/apps/web/src/lib/apiForms.ts" <<'TS'
...
# --- Web pages ---
cat > "$ROOT/apps/web/src/pages/admin/forms/index.tsx" <<'TS'
...
cat > "$ROOT/apps/web/src/pages/admin/forms/[slug].tsx" <<'TS'
import React from "react";
import AdminLayout from "@/components/admin/AdminLayout";
import SectionLayout from "@/components/admin/SectionLayout";
import * as formsApi from "@/lib/apiForms";
...
echo "  - sql/2025-10-31_custom_forms.sql"
echo "  - services/api/src/modules/forms/customForms.controller.ts"
echo "  - services/api/src/modules/forms/customForms.service.ts"
echo "  - apps/web/src/lib/apiForms.ts"
echo "  - apps/web/src/pages/admin/forms/index.tsx"
echo "  - apps/web/src/pages/admin/forms/[slug].tsx"